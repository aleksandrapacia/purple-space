...
class MenuScreen(Screen):
    ...
    def moon_map(self):
        self.manager.current = 'moon_map'
    def tracking_iss(self):
...
class AboutScreen(Screen):
    ...
    def open_repo(self):
        webbrowser.open("https://github.com/aleksandrapacia/unknown-space")

# This Month

class MoonMap(Screen):
    Builder.load_file('screens//moon_map.kv')
    def come_back_m_n(self):
        self.manager.current = 'menu'
...
class MoonPhaseScreen(Screen):
    ...
    def info_clicked(self):
        self.manager.current = 'phas_info'
